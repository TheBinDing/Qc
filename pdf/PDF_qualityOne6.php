...
require('../fpdf.php');
require('../func/PDFOne6Search.php');
...
class PDF extends FPDF
{
    function BasicTable($data, $site, $a11, $a12, $a13, $d1, $a21, $a22, $a23, $d2, $a31, $a32, $a33, $d3, $a41, $a42, $a43, $d4, $a51, $a52, $a53, $d5, $a61, $a62, $a63, $d6, $a71, $a72, $a73, $d7, $a81, $a82, $a83, $d8, $c1, $c2, $c3, $c4, $c5, $s1, $s2, $s3, $day, $day2, $day3) {
        ...
        $this->Ln(3);
        $this->Cell(190, 5, iconv('UTF-8', 'TIS-620', 'QC: หมวดที่ 1 - งานโครงสร้าง(โครงสร้างฐานราก)'), 0, 1 ,'C');
        $this->Ln(3);
        ...
        $this->Cell(30, 4, iconv('UTF-8', 'TIS-620', 'โครงสร้างฐานราก'), 'LT', 0);
