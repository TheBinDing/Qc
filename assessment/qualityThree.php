<?php
    ...
    require("func/qualityThreeSearch.php");
?>
    ...
    <div class="row">
        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="wrapper wrapper-content animated fadeInRight ecommerce">
                <h1 style="text-align: center;"> QC: หมวดที่ 3 งานฉาบปูน </h1>
                <form action="../assessment/func/qualityThreeSave.php" method="POST" enctype="multipart/form-data">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <h2 style="text-align: center;background-color: gray;height: 50px;color: black;padding-top: 10px;">งานฉาบปูน</h2>
                            <h4 style="height: 20px;color: black;">งานฉาบปูน</h4>
                            <div class="form-group">
                                <div class="col-lg-1"></div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-6" >
                                    <h4 style="height: 20px;color: black;">1.1 งานฉาบปูน ลักษณะผิวปูน - ความเรียบ และความสูง  </h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">1.เรียบไม่เป็นคลื่น , ไม่มีรอยต่อ ,ไม่แตกร้าว , ฉาบสุดท้องคาน</h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">2.เรียบมีคลื่นบ้าง , ไม่มีรอยต่อ , ไม่แตกร้าว , ฉาบสุดท้องคาน</h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">3.เป็นคลื่น , มีรอยต่อ , แตกร้าว , ฉาบไม่สุดท้องคานและความสูง</h4>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-6" >
                                    <h4 style="height: 20px;color: black;">1.2 แนว , มุมผนัง และมุมเสา - แนวดิ่ง , แนวราบ และมุมฉาก </h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">1.ไม่ล้มดิ่ง - คดงอ -ผิดแนว < 0.5 ซม.</h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">2. ล้มดิ่ง - คดงอ - ผิดแนว > 0.5 ซม. </h4>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-6" >
                                    <h4 style="height: 20px;color: black;">1.3 แนว , ร่อง ผนังด้านล่าง </h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">1.ตัดแต่งได้เรียบสูงจากพื้น 3 ซม.</h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">2.ตัดแต่งไม่เรียบร้อย</h4>
                                </div>
                                <div class="col-lg-1" style="padding-top: 60px;">
                            ...
                            <div class="form-group">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-6" >
                                    <h4 style="height: 20px;color: black;">1.4 ความเรียบร้อยบริเวณช่องบล็อกไฟ , แอร์ ,กำจัดปลวก </h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">1.ตัดแต่งเท่ากับขนาดตัวบล็อก </h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">2.ไม่ได้ตัดแต่งปากบล็อก</h4>
                                </div>
                                <div class="col-lg-1" style="padding-top: 60px;">
                            ...
                            <div class="form-group">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-6" >
                                    <h4 style="height: 20px;color: black;">1.5  การเซาะร่องกันน้ำย้อน </h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">1.มีร่องกันน้ำย้อนและเรียบร้อย</h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">2.ไม่มีร่องกันน้ำย้อนหรือไม่เรียบร้อย</h4>
                                </div>
                                <div class="col-lg-1" style="padding-top: 60px;">
                            ...
                            <div style="clear:both;"></div>
                            <h4 style="height: 20px;color: black;"> งานติดตั้งวงกบ , และช่องสำหรับประตู - หน้าต่างอลูมิเนียม</h4>
                            <h4 style="padding-left: 20px;height: 20px;color: black;">งานติดตั้งวงกบ</h4>
                            <div class="form-group">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-6" >
                                    <h4 style="height: 20px;color: black;">1.6  การติดตั้งวงกบต้องได้ระนาบดิ่งและฉาก (วงกบไม้และเหล็ก) </h4>
                            ...
                            <div style="clear:both;"></div>
                            <h4 style="padding-left: 20px;height: 20px;color: black;">งานช่องสำหรับประตู - หน้าต่างอลูมิเนียม  </h4>
                            <div class="form-group">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-6" >
                                    <h4 style="height: 20px;color: black;">1.7  ช่องว่างระหว่างขอบปูนกับขอบวงกบ </h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">1.ช่องว่างมีขนาด 3-5 มม.</h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">2.ช่องว่างมีขนาด > 5 มม.</h4>
                                </div>
                                <div class="col-lg-1" style="padding-top: 60px;">
                            ...
                            <div class="form-group">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-6" >
                                    <h4 style="height: 20px;color: black;">1.8  งานอุดปูนรอบวงกบ ความเรียบและความแน่น</h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">1.อุดปูนทั้งด้านนอก-ด้านในก่อนการฉาบไม่มีแสงลอด</h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">2.อุดปูนไม่เรียบร้อยก่อนการฉาบ ไม่อุดปูน</h4>
                                </div>
                                <div class="col-lg-1" style="padding-top: 60px;">
