<?php
    ...
    require("func/qualityOne5Search.php");
?>
    ...
    <div class="row">
        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="wrapper wrapper-content animated fadeInRight ecommerce">
                <h1 style="text-align: center;"> QC: หมวดที่ 1 - งานโครงสร้าง (โครงสร้างผนังกันดิน) </h1>
                <form action="../assessment/func/qualityOne5Save.php" method="POST" enctype="multipart/form-data">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <h2 style="text-align: center;background-color: gray;height: 50px;color: black;padding-top: 10px;">โครงสร้างผนังกันดิน</h2>
...
<script type="text/javascript">
    ...
    function sum1() {
        ...
        a = (parseInt(a1) + parseInt(a2) + parseInt(a3) + parseInt(a4) + parseInt(a5) + parseInt(a6) + parseInt(a7) + parseInt(a8) + parseInt(a9));
