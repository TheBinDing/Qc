<?php
    ...
    require("func/qualityOne3Search.php");
?>
    ...
    <div class="row">
        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="wrapper wrapper-content animated fadeInRight ecommerce">
                ...
                <form action="../assessment/func/qualityOne3Save.php" method="POST" enctype="multipart/form-data">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-6" >
                                    <h4 style="height: 20px;color: black;">นั่งร้านรับแบบพื้น </h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">1 นั่งร้านรับแบบพื้น แข็งแรงและจำนวนเพียงพอ</h4>
                                    <h4 style="padding-left: 50px;height: 20px;color: black;">2 นั่งร้านรับแบบพื้น ไม่แข็งแรงและจำนวนไม่เพียงพอ</h4>
                                </div>
                                <div class="col-lg-1" style="padding-top: 60px;">
