<?php
    ...
    require("func/qualityOne2Search.php");
?>
    ...
    <div class="row">
        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="wrapper wrapper-content animated fadeInRight ecommerce">
                <h1 style="text-align: center;"> QC: หมวดที่ 1 - งานโครงสร้าง (โครงสร้างคาน) </h1>
                <form action="../assessment/func/qualityOne2Save.php" method="POST" enctype="multipart/form-data">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <h2 style="text-align: center;background-color: gray;height: 50px;color: black;padding-top: 10px;">โครงสร้างคาน</h2>
