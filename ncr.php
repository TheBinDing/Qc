    ...
    <div class="row">
        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="wrapper wrapper-content animated fadeInRight ecommerce">
                <h1>
                    <span> NCR </span>
                    <a class="glyphicon glyphicon-plus-sign" href="ncrDetail.php"></a>
                </h1>
                    ...
                    <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="10">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;">สถานะ NCR</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                                for($p=1;$p<=$num;$p++) {
                                    ...
                                    if($row['Status'] == '0') {
                                        $status = 'รอการประเมินงบ';
                                    }
                                    if($row['Status'] == '1') {
                                        $status = 'ประเมินงบเรียบร้อย';
                                    }
                            ?>
                            <tr>
