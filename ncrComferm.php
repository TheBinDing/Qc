                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a href="func/ncrComUpdate.php?ncr_id=<?php echo $row['ID']; ?>" class="btn-white btn btn-xs" role="button">Comferm NCR</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
