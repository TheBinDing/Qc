                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <div <?php if($row['Status'] == 2) { $none = '    pointer-events: none;cursor: not-allowed;box-shadow: none;opacity: 0.65;'; } ?> >
                                        <a href="assessmentDetail.php?ncr_id=<?php echo $row['ID']; ?>" class="btn-white btn btn-xs" role="button">ประเมินงบประมาณ</a>
                                    </div>
                                </td>
                            </tr>
                            <?php } ?>
...
<script type="text/javascript">
    ...
    $('.btn-ncr').click(function(){
        var ncr = $(this).data("code");

        window.open("pdf/PDF_NCR.php?NCR="+ ncr);
    });
</script>
